	...
	public void onClick(View v)
	{
		...
		switch(v.getId())
		{
			...
			case 32:
				...
				{
					String s;
					//s="mqqapi://card/show_pslcard?card_type=group&uin=143759250";
					s="bXFxYXBpOi8vY2FyZC9zaG93X3BzbGNhcmQ/Y2FyZF90eXBlPWdyb3VwJnVpbj0xNDM3NTkyNTA";
				...
				{
					s="5peg5rOV5omT5byAUVHvvIzlj6/og73mnKrlronoo4VRUe+8gQ==";
					s=new String(android.util.Base64.decode(s,android.util.Base64.DEFAULT));
			...
			case 33:
				...
				{
					s="5peg5rOV5omT5byA5pSv5LuY5a6d77yM5Y+v6IO95pyq5a6J6KOF5pSv5LuY5a6d77yB";
					s=new String(android.util.Base64.decode(s,android.util.Base64.DEFAULT));
